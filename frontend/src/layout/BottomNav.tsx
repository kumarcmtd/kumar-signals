...
import { FlaskConical, Crown, ShieldCheck, BarChart3, BookOpen, BrainCircuit, Cpu, TrendingUp, TrendingDown, LineChart, Calculator, NotebookText, Bell, Settings } from "lucide-react";
