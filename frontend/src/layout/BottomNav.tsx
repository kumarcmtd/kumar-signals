...
import { FlaskConical, Crown, ShieldCheck, BarChart3, BookOpen, BrainCircuit, Cpu, TrendingUp, TrendingDown, Rocket, LineChart, Calculator, NotebookText, Bell, Settings, GraduationCap, Crosshair } from "lucide-react";
