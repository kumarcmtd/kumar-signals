...
function computeSummary(trades: PortfolioTrade[]) {
  ...
  return { openCount: open.length, closedCount: closed.length, totalPnl, winRate, profitFactor, avgWin, avgLoss, best, worst };
}
